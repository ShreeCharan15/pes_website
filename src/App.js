...
function App() {
  return (
    <div className="App">
      <Box bgGradient="linear(to-br, white, #9dea7e)" style={{minHeight:"100vh"}}>
      <Box w="100%" h="70px"   borderRadius="0px 0px 40px 40px"  padding={3}>
          <div className="container">
            <div className="row">
              <div className="col-auto">
                <img src="./logo-blue.png" style={{maxHeight:"60px"}}></img>
              </div>
              <div className="col">
              </div>
              <div className="col">
